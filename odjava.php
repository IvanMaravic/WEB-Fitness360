...
<body>
  <div class="container">
    ...
    if(isset($_SESSION['u_name'])){
      echo "<p>Prijavljeni ste kao ".$_SESSION['u_name'].".</p>";
    }else{
      echo "<p>Jeste li sigurni da se želite odjaviti?.</p>";
    }
    ?>
    <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
      <input type="submit" name="submit" id="button" value="Odjava">
    </form>
  </div>
...
<style>
  ...
  #button{
    ...
    box-shadow:  -5px -5px 10px #161568,
    5px 5px 10px #723bff;
}
  #button:hover{
